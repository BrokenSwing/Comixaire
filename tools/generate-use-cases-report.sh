...
pandoc ./reports-fragments/use-cases-intro.md -f markdown+yaml_metadata_block --template eisvogel --table-of-contents --toc-depth 6 --number-sections --top-level-division=chapter --highlight-style breezedark -o ../output/report.pdf
cd ..
rm -rf ./tmp